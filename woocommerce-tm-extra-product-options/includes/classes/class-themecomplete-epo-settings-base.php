...
final class THEMECOMPLETE_EPO_SETTINGS_Base {
	...
	public function settings_options() {
		$settings_options = [
			...
			'builder'  => [ 'tcfa tcfa-puzzle-piece', esc_html__( 'Builder', 'woocommerce-tm-extra-product-options' ) ],
			'other'    => 'other',
	 ...
	 * @since 6.4.7
	 */
	public function plugin_settings_data() {
		$settings = [];
	...
	public function plugin_settings() {
		$settings = $this->plugin_settings_data();
	...
	public function get_setting_general( $setting, $label ) {
		return [
			...
			[
				...
				'class'   => 'tcinit wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '@everyone',
				'type'    => 'multiselect',
			...
			[
				...
				'options' => [
					...
					'homepage'            => esc_html__( 'Homepage', 'woocommerce-tm-extra-product-options' ),
					'pages'               => esc_html__( 'WordPress Pages', 'woocommerce-tm-extra-product-options' ),
					'specific_ids'        => esc_html__( 'Specific Posts, Pages, or Products', 'woocommerce-tm-extra-product-options' ),
				],
			],
			[
				'title'   => esc_html__( 'Allowed IDs', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Enter comma-separated IDs of posts, pages, or products where the plugin should load (e.g. 42, 88, 156).', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_loading_areas_allowed_ids',
				'default' => '',
				'class'   => 'tcinit',
				'type'    => 'text',
			],
			[
				...
				'class'   => 'tcftb wc-enhanced-select',
				'css'     => 'min-width:300px;',
	...
	public function get_setting_display( $setting, $label ) {
		return [
			...
			[
				...
				'id'      => 'tm_epo_display',
				'class'   => 'tcdisplay wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => 'normal',
				'type'    => 'select',
				'options' => [
			...
			[
				...
				'class'   => 'tcplacement wc-enhanced-select',
				'css'     => 'min-width:300px;',
			...
			[
				...
				'class'   => 'tcftbox wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => 'disable',
				'type'    => 'select',
				'options' => [
			...
			[
				'title'   => esc_html__( 'Do not auto hide price if the original price is not zero', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Check this to show the price display if the original price is not zero.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_no_hide_price_if_original_not_zero',
				'class'   => 'tcprice',
				'default' => 'no',
				'type'    => 'checkbox',
			],
	...
	public function get_setting_cart( $setting, $label ) {
		return [
			...
			[
				'title'   => esc_html__( 'Hide extra addon prices in cart and checkout', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Enables or disables the display of addon prices in the cart and checkout.', 'woocommerce-tm-extra-product-options' ),
	...
	public function get_setting_order( $setting, $label ) {
		return [
			...
			[
				'title'   => esc_html__( 'Show uploaded image in order', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Enabling this will show the uploaded images in order.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_show_upload_image_replacement_order',
				'default' => 'yes',
				'type'    => 'checkbox',
			],
			[
	...
	public function get_setting_string( $setting, $label ) {
		return [
			...
			[
				'title'       => esc_html__( 'Product Element Final total text', 'woocommerce-tm-extra-product-options' ),
				'desc'        => esc_html__( 'Enter the Final Total label for the embedded product element or leave blank for the default text.', 'woocommerce-tm-extra-product-options' ),
				'id'          => 'tm_epo_item_final_total_text',
				'placeholder' => esc_html__( 'Item Total', 'woocommerce-tm-extra-product-options' ),
				'default'     => '',
				'class'       => 'tcsfinaltotalbox',
				'type'        => 'text',
			],
			[
				'title'       => esc_html__( 'Product Element Unit price text', 'woocommerce-tm-extra-product-options' ),
				'desc'        => esc_html__( 'Enter the Unit Price label for the embedded product element or leave blank for the default text.', 'woocommerce-tm-extra-product-options' ),
				'id'          => 'tm_epo_item_options_unit_price_text',
				'placeholder' => esc_html__( 'Item Unit Price', 'woocommerce-tm-extra-product-options' ),
				'default'     => '',
				'class'       => 'tcsfinaltotalbox',
				'type'        => 'text',
			],
			[
				'title'       => esc_html__( 'Product Element Options total text', 'woocommerce-tm-extra-product-options' ),
				'desc'        => esc_html__( 'Enter the Options Total label for the embedded product element or leave blank for the default text.', 'woocommerce-tm-extra-product-options' ),
				'id'          => 'tm_epo_item_options_total_text',
				'placeholder' => esc_html__( 'Item Options Amount', 'woocommerce-tm-extra-product-options' ),
				'default'     => '',
				'class'       => 'tcsfinaltotalbox',
				'type'        => 'text',
			],
			[
				'title'       => esc_html__( 'Product Element Options VAT total text', 'woocommerce-tm-extra-product-options' ),
				'desc'        => esc_html__( 'Enter the VAT Total label for the embedded product element or leave blank for the default text.', 'woocommerce-tm-extra-product-options' ),
				'id'          => 'tm_epo_item_vat_options_total_text',
				'placeholder' => esc_html__( 'Item Options VAT Amount', 'woocommerce-tm-extra-product-options' ),
				'default'     => '',
				'class'       => 'tcsfinaltotalbox',
				'type'        => 'text',
			],
	...
	public function get_setting_global( $setting, $label ) {
		return [
			...
			[
				...
				'class'   => 'tcglobal1 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'select',
				'options' => [
			...
			[
				'title'   => esc_html__( 'Disable Database Query Cache', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Prevents caching of database queries when loading extra product options (e.g., with get_posts()). Use this for development or if options are not updating as expected.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_disable_database_query_cache',
				'default' => 'no',
				'class'   => 'tcglobal1',
				'type'    => 'checkbox',
			],
			...
			[
				...
				'class'   => 'tcglobal6 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'select',
				'options' => [
			...
			[
				'title'       => esc_html__( 'Maximum number of combinations for price calculations', 'woocommerce-tm-extra-product-options' ),
			...
			[
				...
				'class'   => 'tcglobal8 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'select',
				'options' => [
			...
			[
				...
				'class'   => 'tcglobal5 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => 'browser',
				'type'    => 'select',
				'options' => [
			...
			[
				...
				'class'   => 'tcglobal7 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => 'right',
				'type'    => 'select',
				'options' => [
			...
			[
				'title'   => esc_html__( 'Include the WooCommerce Price display suffix on product price', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Enable this to add the WooCommerce Price display suffix on the main product price.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_global_wc_main_price_suffix',
				'default' => 'yes',
				'class'   => 'tcglobal3',
				'type'    => 'checkbox',
			],
			...
			[
				...
				'class'   => 'tcglobal3 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => 'self',
				'type'    => 'select',
				'options' => [
			...
			[
				'title'   => esc_html__( 'Show Prices on Styled Variation Attributes', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Displays the price of each variation directly on the corresponding attribute option. This feature only works when the product has a single attribute per variation and the Styled Variations feature of the plugin is enabled.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_styled_variation_price_display',
				'default' => 'no',
				'class'   => 'tcglobal3',
				'type'    => 'checkbox',
			],
			[
				...
				'class'   => 'tcglobal2 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'multiselect',
		...
		return [
			[
				...
				'desc'  => '<span tabindex="0" data-menu="tcelements1" class="tm-section-menu-item">' . esc_html__( 'General', 'woocommerce-tm-extra-product-options' ) . '</span>' .
						'<span tabindex="0" data-menu="tcelements8" class="tm-section-menu-item">' . esc_html__( 'Grid', 'woocommerce-tm-extra-product-options' ) . '</span>' .
			...
			[
				'title'       => esc_html__( 'Main Row gap', 'woocommerce-tm-extra-product-options' ),
				/* translators: %1$s <br> %2$s code text */
				'desc'        => sprintf( esc_html__( 'Set the row gap between sections and fields. %1$s This will be the %2$s css variable.', 'woocommerce-tm-extra-product-options' ), '<br>', '<code>--tcgaprow</code>' ),
				'id'          => 'tm_epo_global_row_gap',
				'class'       => 'tcelements8',
				'default'     => '15px',
				'placeholder' => '15px',
				'type'        => 'text',
			...
			[
				'title'       => esc_html__( 'Main Column gap', 'woocommerce-tm-extra-product-options' ),
				/* translators: %1$s <br> %2$s code text */
				'desc'        => sprintf( esc_html__( 'Set the column gap between sections and fields. %1$s This will be the %2$s css variable.', 'woocommerce-tm-extra-product-options' ), '<br>', '<code>--tcgapcolumn</code>' ),
				'id'          => 'tm_epo_global_column_gap',
				'class'       => 'tcelements8',
				'default'     => '15px',
				'placeholder' => '15px',
				'type'        => 'text',
			...
			[
				'title'       => esc_html__( 'Inner Row gap', 'woocommerce-tm-extra-product-options' ),
				/* translators: %1$s <br> %2$s code text */
				'desc'        => sprintf( esc_html__( 'Set the inner row gap between field elements. %1$s This will be the %2$s css variable.', 'woocommerce-tm-extra-product-options' ), '<br>', '<code>--tcinnergaprow</code>' ),
				'id'          => 'tm_epo_global_row_inner_gap',
				'class'       => 'tcelements8',
				'default'     => '',
				'placeholder' => 'calc(var(--tcgaprow) / 2)',
				'type'        => 'text',
			],
			[
				'title'       => esc_html__( 'Inner Column gap', 'woocommerce-tm-extra-product-options' ),
				/* translators: %1$s <br> %2$s code text */
				'desc'        => sprintf( esc_html__( 'Set the inner column gap between field elements. %1$s This will be the %2$s css variable.', 'woocommerce-tm-extra-product-options' ), '<br>', '<code>--tcinnergapcolumn</code>' ),
				'id'          => 'tm_epo_global_column_inner_gap',
				'class'       => 'tcelements8',
				'default'     => '',
				'placeholder' => 'calc(var(--tcgapcolumn) / 2)',
				'type'        => 'text',
			],
			[
			...
			[
				...
				'class'   => 'tcelements1 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => 'relative',
				'type'    => 'select',
				'options' => [
			...
			[
				'title'   => esc_html__( 'Enable quantity selector buttons', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Activate to show quantity buttons for the addon quantity selector.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_global_quantity_selector_buttons',
				'default' => 'no',
				'class'   => 'tcelements1',
				'type'    => 'checkbox',
			],
			...
			[
				...
				'class'   => 'tcelements2 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'select',
				'options' => [
			...
			[
				...
				'class'   => 'tcelements3 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'select',
				'options' => [
			...
			[
				...
				'class'   => 'tcglobtcelements3al4 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'select',
				'options' => [
			...
			[
				'title'   => esc_html__( 'Enable product element quantity buttons', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Activate to show quantity buttons for the product quantity.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_global_quantity_buttons_product_element',
				'default' => 'no',
				'class'   => 'tcelements6',
				'type'    => 'checkbox',
			],
	...
	public function get_setting_math( $setting, $label ) {
		$html = '<div class="tc-constants-container"></div><div class="tm-mn-header"><div class="tm-mn-path">'
	 ...
	 * @since 1.0
	 */
	public function get_setting_builder( $setting, $label ) {
		return [
			[
				'type'  => 'tm_title',
				'id'    => 'epo_page_options',
				'desc'  => '<span tabindex="0" data-menu="tcbuilder1" class="tm-section-menu-item">' . esc_html__( 'Defaults', 'woocommerce-tm-extra-product-options' ) . '</span>' .
						'<span tabindex="0" data-menu="tcbuilder2" class="tm-section-menu-item">' . esc_html__( 'Overrides', 'woocommerce-tm-extra-product-options' ) . '</span>',
				'title' => $label,
			],
			[
				'title'   => esc_html__( 'Section Label type', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Set the default heading for new section labels in the builder. This avoids manually reselecting the label type each time you create a section.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_default_section_label_type',
				'class'   => 'tcbuilder1 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '2',
				'type'    => 'select',
				'options' => [
					'1' => esc_html__( 'H1', 'woocommerce-tm-extra-product-options' ),
					'2' => esc_html__( 'H2', 'woocommerce-tm-extra-product-options' ),
					'3' => esc_html__( 'H3', 'woocommerce-tm-extra-product-options' ),
					'4' => esc_html__( 'H4', 'woocommerce-tm-extra-product-options' ),
					'5' => esc_html__( 'H5', 'woocommerce-tm-extra-product-options' ),
					'6' => esc_html__( 'H6', 'woocommerce-tm-extra-product-options' ),
					'7' => esc_html__( 'p', 'woocommerce-tm-extra-product-options' ),
					'8' => esc_html__( 'div', 'woocommerce-tm-extra-product-options' ),
					'9' => esc_html__( 'span', 'woocommerce-tm-extra-product-options' ),
				],
			],
			[
				'title'   => esc_html__( 'Element Label type', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Set the default heading for new element labels in the builder. This avoids manually reselecting the label type each time you create an element.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_default_element_label_type',
				'class'   => 'tcbuilder1 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '3',
				'type'    => 'select',
				'options' => [
					...
					'8'  => esc_html__( 'div', 'woocommerce-tm-extra-product-options' ),
					'9'  => esc_html__( 'span', 'woocommerce-tm-extra-product-options' ),
					'10' => esc_html__( 'label', 'woocommerce-tm-extra-product-options' ),
				],
			],
			[
				'title'   => esc_html__( 'Section Label type', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Override how section labels appear on the frontend while preserving their original settings in the builder. This lets you maintain different heading levels for editing while enforcing consistent output.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_override_section_label_type',
				'class'   => 'tcbuilder2 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'select',
				'options' => [
					''  => esc_html__( 'Use Builder Value', 'woocommerce-tm-extra-product-options' ),
					'1' => esc_html__( 'H1', 'woocommerce-tm-extra-product-options' ),
					'2' => esc_html__( 'H2', 'woocommerce-tm-extra-product-options' ),
					'3' => esc_html__( 'H3', 'woocommerce-tm-extra-product-options' ),
					'4' => esc_html__( 'H4', 'woocommerce-tm-extra-product-options' ),
			...
			[
				'title'   => esc_html__( 'Element Label type', 'woocommerce-tm-extra-product-options' ),
				'desc'    => esc_html__( 'Override how element labels appear on the frontend while preserving their original settings in the builder. This lets you maintain different heading levels for editing while enforcing consistent output.', 'woocommerce-tm-extra-product-options' ),
				'id'      => 'tm_epo_override_element_label_type',
				'class'   => 'tcbuilder2 wc-enhanced-select',
				'css'     => 'min-width:300px;',
				'default' => '',
				'type'    => 'select',
